...
residential=(2011_09_26_calib.zip
    2011_09_26_drive_0019
    2011_09_26_drive_0020
    2011_09_26_drive_0022
    2011_09_26_drive_0023
...
categories["road"]=${road[@]}


for category in "${!categories[@]}"; do
    drives=(${categories[$category]})
    for drive in "${drives[@]}"; do
        if [ ${drive:(-3)} != "zip" ]
        then
                shortname=$drive'_sync.zip'
                fullname=$drive'/'$drive'_sync.zip'
                drive_file="true"
        else
                shortname=$drive
                fullname=$drive
        ...
        echo "Processing " $category " file: " $shortname
        echo "Downloading... "
